@echo off
@title Windows Tweaker By Frankie
...
echo.
echo                                ▄▄▄▄▄▄                                     ##############################
echo                               ████████                                           %COL%[92mWindows Tweaker%COL%[33m
echo                               ████████                                           %COL%[92mby Frankie %COL%[33m
echo                  ▄███▄       ▄████████▄       ▄███▄                       ##############################
echo                ▄███████▄▄▄████████████████▄▄▄███████▄   
...
echo           ███████████████      Frankie     ███████████████                *%COL%[92m Timer Resolution Services%COL%[33m
